            ...
            chapters: [
                 {
                    ...
                    sections: [
                        {id: 1, title: "Treaty of Versailles", content: "The Treaty of Versailles ended World War I and imposed heavy penalties on Germany."},
                        {id: 2, title: "Rise of Fascism", content: "Fascism is a political ideology characterized by dictatorial power, forcible suppression of opposition, and strong regimentation of society."},
                        {id: 3, title: "Appeasement", content: "Appeasement was a policy of making concessions to the dictatorial powers in order to avoid conflict."}
                    ]
                }, 
                {
                    id: 2, 
                    title: "Chapter 2: Major Events", 
                    sections: [
                        {id: 1, title: "Invasion of Poland", content: "The invasion of Poland by Germany in 1939 marked the beginning of World War II."},
                        {id: 2, title: "Pearl Harbor", content: "The attack on Pearl Harbor by Japan in 1941 led to the entry of the United States into the war."},
                        {id: 3, title: "D-Day", content: "D-Day was the Allied invasion of Normandy in 1944, which was a turning point in the war."}
                    ]
                },
                {
                    id: 3,
                    ...
                    sections: [
                        {id: 1, title: "The Holocaust", content: "The Holocaust was the genocide of European Jews during World War II."},
                        {id: 2, title: "The Cold War", content: "The Cold War was a period of geopolitical tension between the United States and the Soviet Union and their respective allies."},
                        {id: 3, title: "The United Nations", content: "The United Nations is an intergovernmental organization that aims to maintain international peace and security."}
                    ]
                }
            ]
          },
